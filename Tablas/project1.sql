...
CREATE TABLE cuentas(
    ...
    FOREING KEY(codigoOficina) REFERENCES oficinas
);
...
CREATE TABLE titulares(
    ...
    RIMARY KEY(codigoCLiente,numeroCuenta),
    FOREING KEY(codigoCLiente) REFERENCES clientes,
    FOREING KEY(numeroCuenta) REFERENCES cuentas
);
